...
Revision ID: 3824e1397453
Revises: 04c095274284
Create Date: 2026-06-07 13:21:07.562345
...
revision: str = '3824e1397453'
down_revision: Union[str, Sequence[str], None] = '04c095274284'
...
def upgrade() -> None:
    ...
    sa.Column('location_standard', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('salary_standard', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
